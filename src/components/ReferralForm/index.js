...
getState()
  ...
  return (
    <>
      ...
      <input type="text" placeholder="Enter Address" name="address" className="border mx-2 mb-2 border-gray-400 p-2 w-full" required />
    <div className="flex justify-around mt-2 w-full sm:flex-col">
      ...
      <input type="text" placeholder="Enter Email Address" name="email" className="border mx-2 mb-2 border-gray-400 p-2 w-full" required />
              
        <select name="clinic" id="cat"  value={category} onChange={(e)=>setCategory(e.target.value)}>
      ...
      <button  className="border border-gray-400 rounded-md bg-black text-white p-2 ">Add New Referral</button>
      </div>
