  ...
  return (
    ...
    <div className="w-full h-full relative ">
      <div className="flex  flex-row gap-10 p-3 sm:flex-col items-center">
        <section className="w-full lg:w-[50%] sm:w-full flex flex-col md:px-2  p-3 lg:p-10 sm:pt-0 sm:mt-0 order-1 sm:order-2">
          <div className="w-full sm:tracking-widest flex justify-center flex-col h-auto lg:pt-7 sm:pt-0">
            ...
            <h1 className="text-6xl dark:text-white mt-5 block  sm:mt-0 sm:text-4xl lg:text-6xl w-full text-black font-extrabold">
